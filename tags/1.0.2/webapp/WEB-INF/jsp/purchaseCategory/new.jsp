...
<html:form action="insertPurchaseCategory${x_version}.do" method="post" onsubmit="return validatePurchaseCategoryForm(this);">
<html:hidden property="site_id"/>
<table width="100%" border="0" cellpadding="4" cellspacing="0">
<tr>
  <td class="bluetext"><bean:message key="purchaseCategory.id"/>:</td>
  <td><bean:message key="purchaseCategory.id.generate"/></td>
</tr>

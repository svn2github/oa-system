...
<logic:notEmpty name="X_SHOWAPPROVEBUTTON">
	...
	<input type="button" value="<bean:message key="approveRequest.reject"/>"	onclick="javascript:doReject(document.forms('approveForm'), 'rejectTravelApplicationApproveRequest.do');">
</logic:notEmpty>
...
<tr>
	<td>
		<jsp:include page="../travelApplication/baseView.jsp"/>
	</td>
</tr>
</table>
<hr/>
...
<td align="right">
<logic:notEmpty name="X_SHOWAPPROVEBUTTON">
	<form name="approveForm" action="approveTravelApplicationApproveRequest.do" method="post">

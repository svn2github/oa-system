...
<html:form action="/updatePurchaseSubCategory${x_version}"  method="post" onsubmit="return validatePurchaseSubCategoryForm(this);">
	<table width=90% border=0 cellpadding=4 cellspacing=0>
		<tr>
			<td class="bluetext"><bean:message key="purchaseSubCategory.id" />:</td>
			<td>
				<html:hidden property="id" />
				<bean:write property="id" name="purchaseSubCategoryForm"/>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<html:hidden property="defaultSupplier_id"/>
				<span id="Supplier"><bean:write property="defaultSupplier_name" name="purchaseSubCategoryForm"/></span>

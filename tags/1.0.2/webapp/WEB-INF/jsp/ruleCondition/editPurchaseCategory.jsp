...
<input type="hidden" name="pvalue_value" value="<bean:write name="ruleConditionForm" property="pvalue"/>">
<input type="hidden" name="value_value" value="<bean:write name="ruleConditionForm" property="value"/>">

...
def var ponbr like xxpo_nbr.
def var ln as inte.
def var rcln as inte label "Line". 
def var tot like xxpod_amt.
def var curtot like xxpod_amt.
def var rcid like xxpore_reid.
def var rcty like xxpore_retype.
def var cscd like xxpore_cscd.
def var amt  like xxpore_amt.
def var pct like xxpore_pct.
...
def temp-table tmp-ep
    ...
    field tmp-nbr  like xxpo_nbr
    field tmp-desc like xxpod_desc format "x(10)"
    field tmp-flag like xxpod_flag
    field tmp-edln like xxpod_edln
    field tmp-type like xxpod_type
    field tmp-amt  like xxpod_cf_amt column-label "Amount"

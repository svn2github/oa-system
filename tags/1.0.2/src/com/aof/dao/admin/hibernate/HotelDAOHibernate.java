...
public class HotelDAOHibernate extends BaseDAOHibernate implements HotelDAO {
    ...
    /* (non-Javadoc)
     * @see com.aof.dao.admin.HotelDAO#getHotel(java.lang.Integer)
     */
    ...
    /* (non-Javadoc)
     * @see com.aof.dao.admin.HotelDAO#updateHotel(com.aof.model.admin.Hotel)
     */
	...
	/* (non-Javadoc)
	 * @see com.aof.dao.admin.HotelDAO#insertHotel(com.aof.model.admin.Hotel)
	 */
    ...
    /* (non-Javadoc)
     * @see com.aof.dao.admin.HotelDAO#getHotelListCount(java.util.Map)
     */
    ...
    /* (non-Javadoc)
     * @see com.aof.dao.admin.HotelDAO#getHotelList(java.util.Map, int, int, com.aof.model.admin.query.HotelQueryOrder, boolean)
     */

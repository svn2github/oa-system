...
/**
 * 该类代表expense_cell_det表中的一行
 * 
 * @author nicebean
 * @version 1.0 (2005-11-18)
 */
public abstract class AbstractExpenseCell implements Serializable {
    /**
    ...
    /** default constructor */
    public AbstractExpenseCell() {
    }

    /** minimal constructor */
    public AbstractExpenseCell(Integer id) {
        setId(id);
    }
     ...
     *            The row to set.
     */
    public void setRow(ExpenseRow row) {
        this.row = row;
    }
    ...
    public boolean equals(Object rhs) {
        ...
        if (this == rhs)
            return true;
        if (!(rhs instanceof ExpenseCell))
            return false;
        ExpenseCell that = (ExpenseCell) rhs;
        if (this.getId() != null)

...
<logic:present name="X_MEENABLED">
		if (form.enabled.value != "${X_ENABLED.enumCode}") {
			warningMsg += '<bean:message key="flow.noEnabled.message"/>\n';
		}
</logic:present>
...
<html:form action="update${X_RULETYPE.prefixUrl}Flow.do" onsubmit="return validateForm(this);">
<html:hidden property="id"/>
<html:hidden property="site_id"/>
<html:hidden property="site_name"/>
...
<tr>
  ...
  <td><bean:write name="flowForm" property="id"/></td>
</tr>
<tr>

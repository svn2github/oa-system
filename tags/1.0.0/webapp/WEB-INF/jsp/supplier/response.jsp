...
<!--
	...
	function response(id) {
		window.location.href="responsePromoteSupplierResult.do?id="+id;
	}
...
//-->
	...
	<table width=90% border=0 cellpadding=4 cellspacing=0>
		<tr>
			...
			<td><textarea rows = "8"  cols="70" readonly="true">${x_supplier.promoteMessage}</textarea>
			</td>
		</tr>
	</table>
	...
	<table width="90%">
		<tr>
			<td align="right">
			<input type="button" onClick='response("${x_supplier.id}")' value="<bean:message key="all.submit" />"/>

...
<html:javascript formName="cityForm" staticJavascript="false"/>
...
<html:form action="/insertCity" onsubmit="return validateCityForm(this)">
	<html:hidden property="province_id"/>
	<html:hidden property="site_id"/>
	<table width=90% border=0 cellpadding=4 cellspacing=0>
		<tr>
			<td class="bluetext"><bean:message key="city.id" />:</td>
			<td>(<bean:message key="common.id.generateBySystem" />)</td>
		</tr>
		<tr>
			<td class="bluetext"><bean:message key="city.engName" />:</td>
			<td><html:text property="engName" /><span
				class="required">*</span></td>
		</tr>
		<tr>
			<td class="bluetext"><bean:message key="city.chnName" />:</td>

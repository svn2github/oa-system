...
<html:form action="updateMenu.do" onsubmit="return validateMenuForm(this);">
<html:hidden property="id"/>
<html:hidden property="parentMenu_id"/>
<div class="warningMsg"><html:errors/></div>
<table border="0" cellpadding="4" cellspacing="0">
<tr>
  <td class="bluetext"><bean:message key="menu.id"/>:</td>
  <td><bean:write name="menuForm" property="id"/></td>
</tr>
<tr>
  <td class="bluetext"><bean:message key="menu.parent"/>:</td>
  <td><bean:write name="menuForm" property="parentMenu_name"/></td>
</tr>
<tr>

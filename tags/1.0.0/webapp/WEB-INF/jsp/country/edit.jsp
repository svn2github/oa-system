...
<html:javascript formName="countryForm" staticJavascript="false"/>
...
<html:form action="/updateCountry" onsubmit="return validateCountryForm(this)">
	...
	<table width=90% border=0 cellpadding=4 cellspacing=0>
		...
		<tr>
			<td class="bluetext"><bean:message key="country.shortName" />:</td>
			<td><html:text property="shortName" /><span
				class="required">*</span></td>
		</tr>
		<tr>
			<td class="bluetext"><bean:message key="country.engName" />:</td>
			<td><html:text property="engName" /><span
				class="required">*</span></td>
		</tr>
		<tr>
			<td class="bluetext"><bean:message key="country.chnName" />:</td>

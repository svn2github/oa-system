...
<script>
	function comboChange()
	{
		with(document.travelApplicationForm)
		{
			...
			action="editTravelApplication_other.do";
			submit();
		}
	}
</script>
...
<html:form action="/updateTravelApplication_other" focus="department_site_id" onsubmit="return validateForm(this)">
	...
	<table width=100%>
		...
		<tr>
			...
			<td width="80%" colspan="3"><html:text property="title" size="60"/><span
				class="required">*</span></td>
		</tr>
		<tr>
	...
	<table width="100%">
		...
		<tr>
			...
			:</td>
			<td width="80%" colspan="3"><html:text property="fromDate" size="6" /><span
			...
			&nbsp;~&nbsp; <html:text property="toDate" size="6" /><span
				class="required">*</span> <a
				onclick="event.cancelBubble=true;"

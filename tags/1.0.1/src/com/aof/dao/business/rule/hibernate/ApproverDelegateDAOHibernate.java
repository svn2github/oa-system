...
public class ApproverDelegateDAOHibernate extends BaseDAOHibernate implements ApproverDelegateDAO {
    ...
    /* (non-Javadoc)
     * @see com.aof.dao.business.rule.ApproverDelegateDAO#getApproverDelegate(java.lang.Integer)
     */
    ...
    /* (non-Javadoc)
     * @see com.aof.dao.business.rule.ApproverDelegateDAO#updateApproverDelegate(com.aof.model.business.rule.ApproverDelegate)
     */
    ...
    /* (non-Javadoc)
     * @see com.aof.dao.business.rule.ApproverDelegateDAO#insertApproverDelegate(com.aof.model.business.rule.ApproverDelegate)
     */
    ...
    /* (non-Javadoc)
     * @see com.aof.dao.business.rule.ApproverDelegateDAO#getApproverDelegateListCount(java.util.Map)
     */
    ...
    /* (non-Javadoc)
     * @see com.aof.dao.business.rule.ApproverDelegateDAO#getApproverDelegateList(java.util.Map, int, int, com.aof.model.business.rule.query.ApproverDelegateQueryOrder, boolean)
     */
    ...
    /* (non-Javadoc)
     * @see com.aof.dao.business.rule.ApproverDelegateDAO#isDelegateApprover(com.aof.model.metadata.ApproverDelegateType, java.lang.Integer, java.lang.Integer)
     */

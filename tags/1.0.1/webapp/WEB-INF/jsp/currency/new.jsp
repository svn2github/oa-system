...
<html:form action="insertCurrency.do" method="post" onsubmit="return validateCurrencyForm(this);">
<table width="100%" border="0" cellpadding="4" cellspacing="0">
<tr>
  <td class="bluetext"><bean:message key="currency.code"/>:</td>
  <td><html:text property="code" maxlength="8"/><span class="required">*</span></td>
</tr>
<tr>

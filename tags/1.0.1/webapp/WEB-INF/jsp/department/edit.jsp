...
<html:form action="updateDepartment.do" onsubmit="return validateDepartmentForm(this);">
...
<tr>
  <td class="bluetext"><bean:message key="department.manager"/>:</td>
  <td><html:select property="manager_id"><html:option value="">　　　　</html:option><html:options collection="X_ENABLEDUSERLIST" property="id" labelProperty="name"/></html:select></td>
</tr>
<tr>

...
<logic:notEmpty name="X_SHOWAPPROVEBUTTON">
	...
	<input type="button" value="<bean:message key="approveRequest.reject"/>"	onclick="javascript:doReject(document.forms('approveForm'), 'rejectPurchaseOrderApproveRequest.do');">
</logic:notEmpty>
...
<td align="right">
<logic:notEmpty name="X_SHOWAPPROVEBUTTON">
	<form name="approveForm" action="approvePurchaseOrderApproveRequest.do" method="post">

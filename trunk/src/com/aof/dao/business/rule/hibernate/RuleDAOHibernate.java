...
public class RuleDAOHibernate extends BaseDAOHibernate implements RuleDAO {
    ...
    /* (non-Javadoc)
     * @see com.aof.dao.business.rule.RuleDAO#getRule(java.lang.Integer, boolean)
     */
    ...
    /* (non-Javadoc)
     * @see com.aof.dao.business.rule.RuleDAO#saveRule(com.aof.model.business.rule.Rule)
     */
	...
	/* (non-Javadoc)
	 * @see com.aof.dao.business.rule.RuleDAO#removeRule(java.lang.Integer)
	 */
	...
	/* (non-Javadoc)
	 * @see com.aof.dao.business.rule.RuleDAO#getRuleListCount(java.util.Map)
	 */
	...
	/* (non-Javadoc)
	 * @see com.aof.dao.business.rule.RuleDAO#getRuleList(java.util.Map, int, int, com.aof.model.business.rule.query.RuleQueryOrder, boolean)
	 */
    ...
    /* (non-Javadoc)
     * @see com.aof.dao.business.rule.RuleDAO#isRuleInUse(java.lang.Integer)
     */
    ...
    /* (non-Javadoc)
     * @see com.aof.dao.business.rule.RuleDAO#getRuleCondition(java.lang.Integer, com.aof.model.metadata.ConditionType)
     */
    ...
    /* (non-Javadoc)
     * @see com.aof.dao.business.rule.RuleDAO#saveRuleCondition(com.aof.model.business.rule.RuleCondition)
     */
    ...
    /* (non-Javadoc)
     * @see com.aof.dao.business.rule.RuleDAO#updateRuleCondition(com.aof.model.business.rule.RuleCondition)
     */
    ...
    /* (non-Javadoc)
     * @see com.aof.dao.business.rule.RuleDAO#removeRuleCondition(com.aof.model.business.rule.RuleCondition)
     */
    ...
    /* (non-Javadoc)
     * @see com.aof.dao.business.rule.RuleDAO#getRuleConsequence(java.lang.Integer, java.lang.Integer)
     */
    ...
    /* (non-Javadoc)
     * @see com.aof.dao.business.rule.RuleDAO#saveRuleConsequence(com.aof.model.business.rule.RuleConsequence)
     */
    ...
    /* (non-Javadoc)
     * @see com.aof.dao.business.rule.RuleDAO#updateRuleConsequence(com.aof.model.business.rule.RuleConsequence)
     */
    ...
    /* (non-Javadoc)
     * @see com.aof.dao.business.rule.RuleDAO#removeRuleConsequence(com.aof.model.business.rule.RuleConsequence)
     */
    ...
    /* (non-Javadoc)
     * @see com.aof.dao.business.rule.RuleDAO#getMaxConsequenceSeqNoForRuleId(java.lang.Integer)
     */
    ...
    /* (non-Javadoc)
     * @see com.aof.dao.business.rule.RuleDAO#getConditionsForRuleId(java.lang.Integer)
     */
    ...
    /* (non-Javadoc)
     * @see com.aof.dao.business.rule.RuleDAO#getConsequencesForRuleId(java.lang.Integer)
     */

...
public class FlowManagerImpl extends BaseManager implements FlowManager {
     ...
     * (non-Javadoc)
     * 
     * @see com.aof.service.business.rule.FlowManager#validateRules(java.util.Collection)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.aof.service.business.rule.FlowManager#executeApproveFlow(com.aof.model.business.Approvable)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.aof.service.business.rule.FlowManager#executePurchaseFlow(com.aof.model.business.Purchasable)
     */

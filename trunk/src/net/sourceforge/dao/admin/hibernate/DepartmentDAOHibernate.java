...
public class DepartmentDAOHibernate extends BaseDAOHibernate implements DepartmentDAO {
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.DepartmentDAO#getDepartment(java.lang.Integer)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.DepartmentDAO#saveDepartment(net.sourceforge.model.admin.Department)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.DepartmentDAO#removeDepartment(java.lang.Integer)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.DepartmentDAO#getDepartmentListCount(java.util.Map)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.DepartmentDAO#getDepartmentList(java.util.Map, int, int, net.sourceforge.model.admin.query.DepartmentQueryOrder, boolean)
     */
	...
	/* (non-Javadoc)
	 * @see net.sourceforge.dao.admin.DepartmentDAO#fillSiteDepartment(java.util.List)
	 */

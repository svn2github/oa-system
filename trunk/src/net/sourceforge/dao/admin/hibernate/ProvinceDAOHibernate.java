...
import net.sourceforge.model.admin.query.ProvinceQueryCondition;
...
public class ProvinceDAOHibernate extends BaseDAOHibernate implements ProvinceDAO {
     ...
     * (non-Javadoc)
     * 
     * @see net.sourceforge.dao.admin.ProvinceDAO#getProvince(java.lang.Integer)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.sourceforge.dao.admin.ProvinceDAO#updateProvince(net.sourceforge.model.admin.Province)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.sourceforge.dao.admin.ProvinceDAO#insertProvince(net.sourceforge.model.admin.Province)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.sourceforge.dao.admin.ProvinceDAO#getProvinceListCount(java.util.Map)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.sourceforge.dao.admin.ProvinceDAO#getEnabledProvinceList()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.sourceforge.dao.admin.ProvinceDAO#getEnabledProvinceList(net.sourceforge.model.admin.Country)
     */

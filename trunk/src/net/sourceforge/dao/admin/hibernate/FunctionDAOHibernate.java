...
import net.sourceforge.model.admin.query.FunctionQueryCondition;
...
public class FunctionDAOHibernate extends BaseDAOHibernate implements FunctionDAO {
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.FunctionDAO#getFunction(java.lang.Integer)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.FunctionDAO#saveFunction(net.sourceforge.model.admin.Function)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.FunctionDAO#getFunctionListCount(java.util.Map)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.FunctionDAO#getFunctionList(java.util.Map, int, int, net.sourceforge.model.admin.query.FunctionQueryOrder, boolean)
     */

...
public class ExchangeRateDAOHibernate extends BaseDAOHibernate implements ExchangeRateDAO {
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.ExchangeRateDAO#getExchangeRate(java.lang.Integer)
     */
	...
	/* (non-Javadoc)
	 * @see net.sourceforge.dao.admin.ExchangeRateDAO#getExchangeRateListCount(java.util.Map)
	 */
	...
	/* (non-Javadoc)
	 * @see net.sourceforge.dao.admin.ExchangeRateDAO#getExchangeRateList(java.util.Map, int, int, net.sourceforge.model.admin.query.ExchangeRateQueryOrder, boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see net.sourceforge.dao.admin.ExchangeRateDAO#insertExchangeRate(net.sourceforge.model.admin.ExchangeRate)
	 */
    /*
    ...
    */
    ...
    /* (non-Javadoc)
	 * @see net.sourceforge.dao.admin.ExchangeRateDAO#updateExchangeRate(net.sourceforge.model.admin.ExchangeRate)
	 */
    /*

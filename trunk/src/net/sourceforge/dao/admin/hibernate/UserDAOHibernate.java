...
public class UserDAOHibernate extends BaseDAOHibernate implements UserDAO {
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.UserDAO#getUser(java.lang.Integer)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.UserDAO#saveUser(net.sourceforge.model.admin.User)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.UserDAO#removeUser(java.lang.Integer)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.UserDAO#getUserListCount(java.util.Map)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.UserDAO#getUserList(java.util.Map, int, int, net.sourceforge.model.admin.query.UserQueryOrder, boolean)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.UserDAO#getUserRoleListByUser(net.sourceforge.model.admin.User)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.UserDAO#getUserRoleListByUserAndFunction(net.sourceforge.model.admin.User, net.sourceforge.model.admin.Function)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.UserDAO#getUserRole(java.lang.Integer)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.UserDAO#saveUserRole(net.sourceforge.model.admin.UserRole)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.UserDAO#removeUserRole(net.sourceforge.model.admin.UserRole)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.UserDAO#getGrantedSiteList(net.sourceforge.model.admin.User, net.sourceforge.model.admin.Function)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.UserDAO#hasSitePower(net.sourceforge.model.admin.Site, net.sourceforge.model.admin.User, net.sourceforge.model.admin.Function)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.UserDAO#getGrantedSiteDeparmentList(net.sourceforge.model.admin.User, net.sourceforge.model.admin.Function)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.UserDAO#hasDepartmentPower(net.sourceforge.model.admin.Department, net.sourceforge.model.admin.User, net.sourceforge.model.admin.Function)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.UserDAO#hasGlobalPower(net.sourceforge.model.admin.User, net.sourceforge.model.admin.Function)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.UserDAO#getGrantedMenuList(net.sourceforge.model.admin.User)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.UserDAO#getSiteOfGrantedSiteDeparmentList(net.sourceforge.model.admin.User, net.sourceforge.model.admin.Function)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.UserDAO#getGrantedDeparmentListOfSite(net.sourceforge.model.admin.User, net.sourceforge.model.admin.Site, net.sourceforge.model.admin.Function)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.UserDAO#hasUserPower(net.sourceforge.model.admin.User, net.sourceforge.model.admin.User, net.sourceforge.model.admin.Function)
     */

...
public class PurchaseCategoryDAOHibernate extends BaseDAOHibernate implements PurchaseCategoryDAO {
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.PurchaseCategoryDAO#getPurchaseCategory(java.lang.Integer)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.PurchaseCategoryDAO#updatePurchaseCategory(net.sourceforge.model.admin.PurchaseCategory)
     */
	...
	/* (non-Javadoc)
	 * @see net.sourceforge.dao.admin.PurchaseCategoryDAO#insertPurchaseCategory(net.sourceforge.model.admin.PurchaseCategory)
	 */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.PurchaseCategoryDAO#getPurchaseCategoryListCount(java.util.Map)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.dao.admin.PurchaseCategoryDAO#getPurchaseCategoryList(java.util.Map, int, int, net.sourceforge.model.admin.query.PurchaseCategoryQueryOrder, boolean)
     */

...
public interface ExpenseAttachmentDAO{
    ...
    /**
     * 保存指定id的ExpenseAttachment内容
     * 
     * @param id
     *            ExpenseAttachment的id
     * @param inputStream
     *            ExpenseAttachment输入流
     */
    public void saveExpenseAttachmentContent(Integer id, InputStream inputStream);

    /**
     * 返回指定id的ExpenseAttachment输入流
     * 
     * @param id
     *            ExpenseAttachment的id
     * @return 指定id的ExpenseAttachment输入流
     */
    public InputStream getExpenseAttachmentContent(Integer id);
    
    /**
     * 删除指定Expense的所有ExpenseAttachment
     * @param expense ExpenseAttachment的expense
     */

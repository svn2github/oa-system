...
import net.sourceforge.dao.admin.FunctionDAO;
...
public class FunctionManagerImpl extends BaseManager implements FunctionManager {
     ...
     * (non-Javadoc)
     * 
     * @see net.sourceforge.service.admin.FunctionManager#isInitiated()
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.sourceforge.service.admin.FunctionManager#initiate(org.apache.struts.config.ModuleConfig)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.sourceforge.service.admin.FunctionManager#getFunction(java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.sourceforge.service.admin.FunctionManager#getFunction(java.lang.Integer)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.sourceforge.service.admin.FunctionManager#saveFunction(net.sourceforge.model.admin.Function)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.sourceforge.service.admin.FunctionManager#getFunctionListCount(java.util.Map)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.sourceforge.service.admin.FunctionManager#getFunctionList(java.util.Map,
     *      int, int, net.sourceforge.model.admin.query.FunctionQueryOrder, boolean)
     */
     ...
     * (non-Javadoc)
     * 
     * @see net.sourceforge.service.admin.FunctionManager#getAllFunction()
     */

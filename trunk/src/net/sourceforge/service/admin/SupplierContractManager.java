...
public interface SupplierContractManager {
     ...
     * 
     */
    public int getSupplierContractListCount(Map condtions) ;
     ...
     * 
     */
    public List getSupplierContractList(Map condtions, int pageNo, int pageSize, SupplierContractQueryOrder order, boolean descend) ;
    
    /**
     * 保存指定的SupplierContract文件内容
     * 
     * @param supplierContract
     *            SupplierContract的id
     * @param inputStream

 ...
 * =====================================================================
 */
package net.sourceforge.service.business.expense.impl;
...
public class ExpenseManagerImpl extends BaseManager implements ExpenseManager {
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.service.business.expense.ExpenseManager#finalConfirm(net.sourceforge.model.business.expense.Expense, java.util.List, java.util.List, java.util.List, net.sourceforge.model.admin.User)
     */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.service.business.expense.ExpenseManager#finalConfirm(java.lang.String, net.sourceforge.model.metadata.YesNo, java.util.List, java.util.List, net.sourceforge.model.admin.User)
     */
    /*
    ...
    */
    ...
    /* (non-Javadoc)
     * @see net.sourceforge.service.business.expense.ExpenseManager#finalClaim(java.lang.String)
     */

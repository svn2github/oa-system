...
<script language="JavaScript">
	...
	function viewItem() {
		window.location.href="listSupplierItem${x_version}.do?supplier_id=${x_supplier.id}";
	}
...
<input type="hidden" name="city_id_value"   value="<bean:write name="supplierForm" property="city_id"/>">
	...
	<tr>
		<td>
			<input type="button" value="<bean:message key="supplier.item"/>" onclick="viewItem()">
		</td>
	</tr>
	</table>
	<table width="90%">
		<tr>
			<td align="right">
			<html:submit>
				<bean:message key="all.confirm" />
			</html:submit>
			<input type="button" value="<bean:message key="all.cancel" />" onClick='doCancel("${x_supplier.id}")' />
			</td>
		</tr>
	</table>
</html:form>

...
<html:form action="/bookAirTicket_result" onsubmit="return validateForm(this)">
	...
	<table width=90% border=0 cellpadding=4 cellspacing=0>
		...
		<tr>
			...
			<td> <html:text property="price" size="4" onkeyup="price_changed(this.value)"/><span class="required">*</span></td>
		</tr>	
